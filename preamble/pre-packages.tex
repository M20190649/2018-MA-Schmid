...
\usepackage{amsthm}
\usepackage{thmtools}
\renewcommand{\listtheoremname}{Wichtige Definitionen}
...
\declaretheorem[name={Definition}, style=theorem]{theorem}
...
% \lstset{
% basicstyle =\fontsize{9}{11}\ttfamily, % Standardschrift
...
\lstset{
basicstyle =\fontsize{8}{10}\ttfamily, % Standardschrift
numbers=left,
numbersep=5pt,
xleftmargin=20pt,
frame=tb,
...
\definecolor{blackkeywords}{rgb}{0,0,0}
