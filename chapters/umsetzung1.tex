...
ab. Welche Probleme hierbei auftreten und wie sich diese auf die Trajektoriedaten auswirken, wurde in
...
Anhand dieser Trajektorien wird anschließend die Geometrie der realen Fahrspuren ermittelt.

In nachfolgender Auflistung sind die drei wichtigsten Vorverarbeitungsschritte aufgeführt:
...
in der Mitte einer Aufnahme beginnen, wenn die verfolgten Fahrzeuge in diesem Bereich beispielsweise aus einem Tunnel hervorkommen.
Unter Anwendung des obigen Ansatzes würden diese Trajektorien fälschlichweise
entfernt. Daher wurde ein anderes Vorgehen gewählt.

Das in der Arbeit eingesetzte Verfahren basiert auf einer anderen Definition von unterbrochenen
...
sind sind potenziell vollständig das heißt ununterbrochen.
...
aus ununterbrochenen Bewegungsbahnen.
...
\begin{figure}[H]
    ...
    \caption[Ergebnisse Clusteranalyse Ansatz DBSCAN und LCSS-Distanz]
            {Ergebnisse Clusteranalyse Ansatz DBSCAN und LCSS-Distanz - gewünschte Clusterergebnisse in a) und b)}
...
\begin{figure}[H]
    \centering
    \subfloat[]{{
        \includegraphics[align=c, width=0.15\linewidth]{resources/img/umsetzung/U1/turning_lane}
    }}
    \qquad \qquad
    \subfloat[]{{
...
\begin{figure}[H]
    ...
    \caption{Ergebnis Clusteranalyse inkl. Abbiegespur-Cluster}
