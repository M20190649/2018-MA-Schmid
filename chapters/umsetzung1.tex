...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Anzahl Überschneidungen über Grenzwert $\rho$: Zurück zu 1) und Anpassung von $\epsilon_{DBSCAN}$
        \item Anzahl Überschneidungen unter Grenzwert $\rho$: Verwendung der Spur-Geometrien
    \end{enumerate}
\end{enumerate}
