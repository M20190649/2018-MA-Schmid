...
werden die verschiedenen Schritte zur Bereinigung und Vorverarbeitung der in dieser Arbeit zum Einsatz kommenden Daten beschrieben.
Dannach folgt die Erläuterung der eigentlichen Clusteranalyse.
...
in der \textit{TrackerApplication} in Form sogenannter \textit{TrackedObject}s gespeichert.
...
\subsection{Entfernung von zu kurzen Trajektorien}
...
\section{Lösungsansätze der Clusteranalyse}
