...
\begin{figure}[H]
    ...
    \subfloat[Iteration 1]{{
        \includegraphics[width=0.2\linewidth]{../resources/img/grundlagen/clustering_EM/EM1}
    }}
    \qquad
    \subfloat[Iteration 2]{{
        \includegraphics[width=0.2\linewidth]{../resources/img/grundlagen/clustering_EM/EM2}
    }}
    \subfloat[Iteration 3]{{
        \includegraphics[width=0.2\linewidth]{../resources/img/grundlagen/clustering_EM/EM3}
    }}
    \subfloat[Iteration 4]{{
        \includegraphics[width=0.2\linewidth]{../resources/img/grundlagen/clustering_EM/EM4}
    }}
