...
\begin{theorem}[Trajektorie]
    ...
    Es sind allerdings auch alternative Darstellung unter Verwendung von Richtungsvektoren oder des zusätzlichen
    Einbezugs von Geschwindigkeitsinformationen et cetera möglich.
\end{theorem}

Eine Rekonstruktion von Fahrzeugtrajektorien wird zwar im Rahmen dieser Arbeit nicht entwickelt,
allerdings ist es wichtig ein Grundverständnis
...
% TODO: Supervised Tracking in einem Absatz vorstellen
% Heute State of the Art: Unsupervised Detection + extra Tracking
% Zwei Abschnitte: Detektion & Tracking

\subsection{Supervised-Tracking}

\begin{theorem}[Supervised-Tracking]
...
\begin{theorem}[Unsupervised-Tracking]
...
Es existieren verschieden Verfahren, welche in die Kategorie des Unsupervised-Tracking fallen. In
...
\textit{Bounding-Boxes} definiert.
...
Fahrbahn-Verdeckungen haben üblicherweise zur Folge, dass die Bewegungsbahnen von Fahrzeugen in den
...
\begin{figure}[H]
    ...
    \caption[Funktionsweise k-Means Clusteralgorithmus]{Funktionsweise k-Means Clusteralgorithmus \cite[]{tan2007introduction}}
