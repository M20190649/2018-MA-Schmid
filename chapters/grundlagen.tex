...
% TODO: Bild Trajektorien (prototypisch)
...
von \cite[]{Hu2005} vorgestellt. Sie ist ein sehr einfaches Distanzmaß, welches auf der mittleren euklidschen Distanz
...
Trajektorien, welche sich zu Beginn sehr ähneln und später auseinanderlaufen, einen sehr Hohen Ähnlichkeitswert besitzen
(siehe Trajektorien $t_X$ und $t_Y$ in Abbildung XXXX). % TODO: Verweis hinzufügen
...
wenn jeder Punkt einer Trajektorie einen nahegelegenen Punkt in der anderen besitzt.
