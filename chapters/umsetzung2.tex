...
identischen Teile werden verworfen und nur jene beibehalten, welche separat verlaufen.
Unproblematisch ist es hingegen, wenn sich Spuren lediglich kreuzen, ihre Überlagerung also nur gering ist.
In diesem Fall dürfen die Spuren nicht partitioniert werden. Nachfolgend wird das Verfahren
zur Identifikation von sich überlagernden Fahrspuren und der Partitionierungsvorgang beschrieben.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\linewidth]{../resources/img/umsetzung/U2/prims_and_secs}
    \caption{Primäre (blau) und sekundäre (grün) Spuren}
