...
\begin{figure}[H]
    ...
    \caption{Plot Spurmittellinien und Hüllen a), Ergebnis Spur-Geometrien in Vehicle-Tracker Applikation b)}
...
\begin{figure}[H]
    ...
    \caption{Primäre (blau) und sekundäre (grün) Spuren a), sich überlagernde und kreuzende Spur-Paare b)}
...
\begin{figure}[H]
    ...
    \caption{Plot partitionierte Spur-Geometrien a), Ergebnis in der Anwendung Vehicle-Tracker b)}
