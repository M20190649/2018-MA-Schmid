...
Die gesuchte Mittellinie verläuft durch die Mitte des entsprechenden
...
\subsection{Angleichung benachbarter Spur-Enden}
...
beziehungsweise enden, um beispielsweise die Positionen von Fahrzeugen auf benachbarten Spuren bei der
Spurwechsel-Analyse besser vergleichen zu können.
...
\begin{figure}[H]
    ...
    \caption[Ergebnis Spurenden-Angleichung]{Mittellinien ohne Angleichung a) und mit Angleichung b)}
...
\begin{figure}[H]
    ...
    \caption{Berechnung der Spur-Hüllpunkte}
    \label{fig:real2_envelope_definition_concept}
\end{figure}
...
sie umgebenden Hüllen. Teil b) zeigt die in die Anwendung \textit{Vehicle-Tracker} eingefügten Spuren.
...
\begin{figure}[H]
    ...
    \caption[Ergebnisse Spur-Geometrie-Bestimmung]{Plot Spur-Geometrien a), Ergebnis Spur-Geometrien in Vehicle-Tracker Applikation b)}
...
\subsubsection{Entfernung unechter Spur-Geometrien}
...
\begin{lstlisting}[caption=Pseudocode Identifikation Spurwechsel-Spur, language=Pseudo, label=lst:pseudo_selectMoreCurvy]
...
\begin{figure}[H]
    ...
    \caption[Konzept Spur-Partitionierung]{Primäre (blau) und sekundäre (grün) Spuren a), sich überlagernde und kreuzende Spur-Paare b)}
...
\begin{figure}[H]
    ...
    \caption[Ergebnisse Spur-Partitionierung]{Plot partitionierte Spur-Geometrien a), Ergebnis in der Anwendung Vehicle-Tracker b)}
...
Wie bereits zu Beginn der Arbeit erwähnt, wurden Fahrspuren in der  bislang manuell
...
\begin{figure}[H]
    ...
    \caption{Angelegte Fahrspuren in der Anwendung Vehicle-Tracker}
