...
Dies ist beispielsweise im Datensatz \textit{Düsseldorf} der Fall. Dessen Trajektorien sind in Abbildung \ref{fig:results_clusters_duesseldorf} a) dargestellt.
...
Anhand von Plot c), welcher die für den Datensatz \textit{Steinheim} berechneten Spur-Geometrien zeigt, wird
