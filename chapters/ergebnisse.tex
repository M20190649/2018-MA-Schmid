...
ist, dass in den Rohdaten genügend intakte Bewegungsbahnen vorhanden sind.
...
keine automatische Neu-Parametrisierung und Durchführung der Clusteranalyse vorgenommen wird.
...
ununterbrochene Trajektorien zur Beschreibung einer Spur vorliegen. Dank sorgfältig gewählter Standardparameter
...
\begin{figure}[H]
    ...
    \subfloat[Heilbronner-Straße]{{
        \includegraphics[align=c, width=0.40\linewidth]{resources/img/results/Heilbronner/improvedLanes_Heilbronner}
    }}
    \qquad \qquad
    \subfloat[Düsseldorf]{{
        \includegraphics[align=c, width=0.40\linewidth]{resources/img/results/Duesseldorf/improvedLanes_Duesseldorf}
    }}
    \hfill
    \subfloat[Steinheim]{{
        \includegraphics[align=c, width=0.40\linewidth]{resources/img/results/Steinheim/improvedLanes}
    }}
...
Häufig gibt es bei der Teilung der Spuren auch kein eindeutiges ``Richtig'' und ``Falsch''.
