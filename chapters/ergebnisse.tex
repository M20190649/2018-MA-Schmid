...
Welche Spur erhalten bleiben soll, ist dann Interpretationssache. Daher, und da der ``Fehler''
leicht über die Oberfläche der \textit{Vehicle-Tracker} Anwendung korrigiert werden kann, wurde der verwendete
