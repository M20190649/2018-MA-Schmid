...
Hierzu definieren die Autoren erstmals die Grundversion des LCSS Ähnlichkeitsmaßes, welches in vielen Arbeiten,
...
\begin{figure}[H]
    \centering
    \subfloat[]{{
        \includegraphics[align=c, width=0.49\linewidth]{../resources/img/RelatedWork/makris_route}
    }}
    \subfloat[]{{
        \includegraphics[align=c, width=0.49\linewidth]{../resources/img/RelatedWork/makris_result}
    }}
