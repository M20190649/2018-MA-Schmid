...
Als Cluster-Algorithmen vergleichen die Autoren den \textit{Spectral-Clustering} Ansatz \cite[]{Ng2002}
...
Sie vergleichen hierzu die Performance von drei unterschiedlichen Distanzmaßen unter Verwendung von zwei Cluster-Algorithmen.
...
Cluster-Algorithmus mit der \textit{Longest-Common-Subsequence} (LCSS) und der \textit{Dynamic-Time-Warping}-Distanz (\acrshort*{dtw}).
