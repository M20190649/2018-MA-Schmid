...
\begin{figure}[H]
    ...
    \caption[Zweistufiger Clustering-Vorgang von Hu et al.]{Zweistufiger Clustering-Vorgang von \cite[]{Hu2005}}
...
Primäres Ziel dieser Arbeit ist es, Fahrspuren zuverlässig in Videoaufnahmen zu erkennen zu. Dieser Abschnitt
geht daher auf Arbeiten mit ähnlichen Ziel ein.

Die meisten Veröffentlichungen in diesem Bereich, löst das Problem, indem sie nach visuellen Merkmalen,
...
Fahrspuren eines Autobahnabschnittes. In dieser Arbeit sollen reale Spurgeometrien für
unterschiedlichste Straßenabschnitte bestimmt werden, weshalb das hierzu eingesetzte Verfahren selbst entwickelt
werden muss. 

Es muss zudem eine Lösung zur Partitionierung von Fahrspuren entwickelt werden, da sich erkannte Spuren
in dieser Arbeit nicht über einen längeren Bereiche hinweg überlagern dürfen. Es muss zudem für jede
